...
pub async fn spawn_app() -> TestApp {
    ...
    let configuration = {
        ...
        let mut c = eventify_primitives::configs::ServerConfig {
            application: eventify_primitives::configs::ApplicationConfig {
                host: String::from("localhost"),
                port: 0,
                worker_threads: 1,
            },
            database: eventify_primitives::configs::DatabaseConfig {
                host: String::from("localhost"),
                port: 5432,
...
async fn configure_database(config: &eventify_primitives::configs::DatabaseConfig) -> PgPool {
    // Create database
